...
def sz_a_spot(date_range: List[datetime.time]) -> List[pd.DataFrame]:
    """获取深证A股的成分股数据"""

def cy_a_spot(date_range: List[datetime.time]) -> List[pd.DataFrame]:
    """获取创业板的成分股数据"""

def kc_a_spot(date_range: List[datetime.time]) -> List[pd.DataFrame]:
    """获取科创板的成分股数据"""
